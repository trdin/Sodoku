...
public class RegionNames {
    ...
    public static final String NUMBER3B = "number3border";
    public static final String NUMBER4B = "number4border";
    public static final String NUMBER5B = "number5border";
    public static final String NUMBER6B = "number6border";
    public static final String NUMBER7B = "number7border";
    public static final String NUMBER8B = "number8border";
